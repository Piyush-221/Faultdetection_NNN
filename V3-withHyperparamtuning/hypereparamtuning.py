...
lgb_model = lgb.LGBMClassifier(objective='multiclass', num_class=len(dataset.classes), metric='multi_logloss')
...
num_round = 100
bst = lgb.train(best_params, train_data, num_round, valid_sets=[train_data, val_data], early_stopping_rounds=10)
